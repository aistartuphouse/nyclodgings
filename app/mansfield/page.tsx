...
export const metadata: Metadata = {
  ...
  description:
    "Hotel-style rooms at 12 W 44th St, Midtown Manhattan: five room types from $575/week, short-term stays on request, utilities and Wi-Fi included. Programming takes place on site.",
};
